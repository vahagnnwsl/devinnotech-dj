jQuery(function ($) {
    ...
    (function (a) {
        ...
        var p = "left", o = "right", e = "up", x = "down", c = "in", z = "out", m = "none", s = "auto", l = "swipe",
            t = "pinch", A = "tap", j = "doubletap", b = "longtap", y = "hold", D = "horizontal", u = "vertical",
        ...
        var t = document.documentElement, e = window, i = function (i, r) {
            ...
            propName: "scrollTo", API: 2, version: "1.7.5", init: function (t, r, s) {
                ...
                var r = this._wdw || !this.skipX ? this.getX() : this.xPrev,
                    s = this._wdw || !this.skipY ? this.getY() : this.yPrev, n = s - this.yPrev, o = r - this.xPrev;
 ...
 */
    ...
    (function (t, e) {
        ...
        if (!i.TweenLite) {
            ...
            for (r = y.prototype, r._calcEnd = !1, r.getRatio = function (t) {
                ...
                var e = this._type, i = this._power, s = 1 === e ? 1 - t : 2 === e ? t : 0.5 > t ? 2 * t : 2 * (1 - t);
    ...
    $(document).ready(function () {
        ...
        function updateHash() {
            ...
            if ((isHash) && ($('.slide[name="' + isHash + '"]').length > 0)) {
                ...
                if (!$body.hasClass("simplifiedMobile")) {
                    ...
                    hideSidebar();
                    $body.animate({scrollTop: requestedElement.position().top}, 1000);
                }
            }
        }
        ...
        function showSlide(requested) {
            ...
            updateNavigation();
            var newSlide = $(".slide").eq(requested - 1), currenSlide = $(".slide.selected"),
        ...
        $(".animated [class*='ae-']:not('.done')").click(function () {
            $(this).addClass("done");
        });
        ...
        $(".slides").bind("mousewheel resize", function (event) {
            ...
            var currentSection = $(".slide.selected .content"), curSecScrolltop = $(currentSection).scrollTop(),
                currentSectionHeight = $(currentSection).find(".container").outerHeight(), minScrollSize = 30;
            if (window.isWindows) {
                minScrollSize = 1;
            }
            if (event.deltaY >= 0) {
            ...
            if ((currentSectionHeight > $(window).height()) && (!window.staticPage)) {
                ...
                if ((window.scrollDirection === "up") && ($(currentSection).scrollTop() === 0)) {
                    ...
                    if ((window.scrollDirection === "down") && ($(currentSection).scrollTop() + $(window).height() >= currentSectionHeight)) {
                        window.allowSlide = 0;
                    }
                }
                if ((!window.sidebarShown) && (!window.popupShown) && (!window.blockScroll)) {
                    if ((!window.isFirefox) && (window.customScroll)) {
                        ...
                        var delta = energy / 120, scrollTime = 0.5, scrollDistance = 100, scrollTop = curSecScrolltop,
        ...
        $(".mobile .slides:not(.simplifiedMobile):not(.simplified)").swipe({
            swipeStatus: function (event, phase, direction, distance) {
                ...
                var currentSection = $(".slide.selected .content"),
                    currentSectionHeight = $(currentSection).find(".container").outerHeight(), next = "up",
                    prev = "down", minDistanceMobile = 30, windowHeight = window.innerHeight;
                ...
                if (!window.sidebarShown) {
                    if (window.horizontalMode) {
                        if (direction === next && distance > minDistanceMobile) {
                            ...
                            if (direction === prev && distance > minDistanceMobile) {
                                changeSlide("decrease");
                            }
                        }
                    } else {
                        if (direction === next && distance > minDistanceMobile && window.allowSwipeUp && window.allowSlide) {
                            ...
                            if (direction === prev && distance > minDistanceMobile && window.allowSwipeDown && window.allowSlide) {
                                changeSlide("decrease");
                            }
                        }
                    }
        ...
        if ($(".panel .compact").length > 0) {
            $(".panel .compact").each(function (index, element) {
                var panel = $(element).parents(".panel"), desktop = $(panel).find(".desktop"), compact = element,
        ...
        $(window).on("keydown", function (e) {
            var delta = 2.5, scrollTime = 0.5, scrollDistance = 50, currentSection = $(".slide.selected .content"),
                scrollTop = $(currentSection).scrollTop(), finalScroll = scrollTop + parseInt(delta * scrollDistance);
            if (e.keyCode === 37) {
                if (window.horizontalMode) {
                    changeSlide("decrease");
                }
        ...
        if ($(navigation).length > 0) {
            ...
            $(window).on("load resize", function () {
                var containerWidth = $(window).height() - $(window).width() * 0.1112 - 100,
                    container = $(".side").removeClass("compact").find("ul"), totalWidth = 0;
        ...
        $(".sidebarTrigger").on("click", function () {
            var sidebarID = $(this).data("sidebar-id"), element = $('.sidebar[data-sidebar-id="' + sidebarID + '"]');
            if (element.length > 0) {
        ...
        $(".popupTrigger").on("click", function () {
            var sidebarID = $(this).data("popup-id"), element = $('.popup[data-popup-id="' + sidebarID + '"]');
            if (element.length > 0) {
                $(element).addClass("visible");
        ...
        function equalizeELements() {
            ...
            if (gridEl.length) {
                $(gridEl).each(function (index, element) {
                    var screenWidth = $(window).width(), collapseWidth = ($(element).hasClass("later")) ? 767 : 1024,
            ...
            $(sliderEl).each(function (index, element) {
                if ($(element).hasClass("clickable")) {
                    $(element).on("mousedown", function () {
                        var el = $(this), selected = $(el).find(".selected"),
                            nextElement = $(selected).nextOrFirst("li"), nextIndex = $(nextElement).index(),
        ...
        $(".dropdownTrigger").click(function () {
            if (window.dropdownShown) {
                ...
                var offset = $(this).offset(), offsetY = Math.ceil(offset.top), offsetX = Math.ceil(offset.left),
                    shareID = $(this).data("dropdown-id"), element = $('.dropdown[data-dropdown-id="' + shareID + '"]');
        ...
        $(".sidebar .mainMenu li a").on('click', function(event) {
            hideSidebar();
        });
 ...
 * Copyright (c) 2014 JГ¶rn Zaefferer; Licensed MIT */
    ...
    $(function () {
        if ($("#contact-form").length > 0) {
            ...
            $(".custom-select li").on("click", function () {
                ...
                if ($(".custom-select").hasClass("reveal")) {
                    ...
                    var selectPosition = $(element).position().top, select_class = $(this).attr("class").split(" ")[0];
                    $(".custom-select ul").attr("style", "transform:translate3d(0,-" + selectPosition + "px,0); -webkit-transform:translate3d(0,-" + selectPosition + "px,0); -moz-transform:translate3d(0,-" + selectPosition + "px,0);-ms-transform:translate3d(0,-" + selectPosition + "px,0);-o-transform:translate3d(0,-" + selectPosition + "px,0);");
            ...
            if (window.location.hash === "#submit") {
                $(".custom-select li.submit-a-bug").click();
                setTimeout(function () {
                    $(".custom-select li.submit-a-bug").click();
                }, 50);
            } else {
                if (window.location.hash === "#question") {
                    $(".custom-select li.technical-question").click();
                    setTimeout(function () {
                        $(".custom-select li.technical-question").click();
                    }, 50);
                }
            ...
            $("#contact-form").ajaxForm({
                type: "post", url: "/wp-admin/admin-ajax.php", dataType: "json", error: function (data) {
                    ...
                    if (data.success === 1) {
                        ...
                        $("#submit").attr("disabled", "disabled").find("span").text("Done!").addClass("done");
        ...
        $("#login-form").ajaxForm({
            ...
            data: {action: "dm_slides_login"},
            dataType: "json",
            error: function (data) {
                console.log(data);
            },
            beforeSubmit: function () {
                $("#label43").removeClass("error");
            },
            success: function (data) {
                if (data.success) {
                    window.location = "/slides/app/";
                    checkPermission();
                } else {
                    if (data.error === 100) {
                        $(".page-loaded").addClass("visiblePanels");
                        $("#label43").addClass("error");
                    }
                }
            }
        });
                ...
                success: function (data) {
                    switch (data.status) {
                        case"not_logged_in":
                            ...
                            break;
                        case"not_purchased":
                            $(".error_el").html('<p class="noLicense">It looks like you didn&rsquo;t buy a license of <b>Slides</b> to use this app. Do you mind to purchase one?</p><a class="button block uppercase pink round wide" href="/slides/#purchase">purchase</a>').show();
                            setTimeout(function () {
                                $(".page-loaded").addClass("visiblePanels");
                            }, 2000);
                            $(".block-43").attr("style", "opacity:0");
                            $("#login-form").hide();
                            break;
                        case"200":
                            window.location = "/slides/app/";
        ...
        if ($(".updates").length > 0) {
            $("li").hover(function () {
                if ($(this).children("dt").hasClass("f")) {
                    $("dt:not(.f)").parent().addClass("obscure");
                    $("dt.f").parent().addClass("highlight");
                } else {
                    if ($(this).children("dt").hasClass("e")) {
                        $("dt:not(.e)").parent().addClass("obscure");
                        $("dt.e").parent().addClass("highlight");
                    } else {
                        if ($(this).children("dt").hasClass("n")) {
                            $("dt:not(.n)").parent().addClass("obscure");
                            $("dt.n").parent().addClass("highlight");
                        } else {
                            if ($(this).children("dt").hasClass("r")) {
                                $("dt:not(.r)").parent().addClass("obscure");
                                $("dt.r").parent().addClass("highlight");
                            }
                        }
                    }
                }
            ...
            var cookieUpdateCount = jQuery.cookie("current-update-count"),
                currentUpdateCount = $(".changes > ul > li").length;
            if ((currentUpdateCount > cookieUpdateCount) || (!cookieUpdateCount)) {
                $("h1").append("<span>" + (currentUpdateCount - cookieUpdateCount) + "</span>");
            }
            console.log(jQuery.cookie("current-update-count", currentUpdateCount, {expires: 365}));
            console.log(jQuery.cookie("current-update-count"));
        }
    });
    ...
    function isVisible($el) {
        ...
        return ((elBottom<= winBottom-400) && (elTop >= winTop-10)) || (elTop + $el.outerHeight(true)>300 && !(elTop >= winTop-10));
    }
    $('body').scroll(function() {
        $( ".slide" ).each(function( index ) {
            if(isVisible($(this))){
                $(this).addClass("selected active animate")
            }
        });
    });
